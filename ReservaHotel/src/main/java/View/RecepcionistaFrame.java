...
public class RecepcionistaFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnCrudReservas, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 90, -1, -1));

        btnCrudClientes.setText("Crud Clientes");
        getContentPane().add(btnCrudClientes, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 90, -1, -1));
